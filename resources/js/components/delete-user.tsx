    ...
    return (
        <div className="space-y-6">
            <HeadingSmall
                ...
                description="Удалите свою учетную запись и все ее ресурсы"
            />
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            После удаления вашей учетной записи все ее ресурсы
                            и данные также будут окончательно удалены. Пожалуйста,
                            введите свой пароль, чтобы подтвердить, что вы хотите
                            окончательно удалить свою учетную запись.
                        </DialogDescription>
